...
| 2 | `feat/schema-seed` | migraciones (tablas, FKs, índices, checks) + `seed.sql` | 50 min | FK compuesta, `unique(source, external_id)`, sin enums, seed fuera de migraciones |
...
Total: ~5 h 35 min + 25 min de colchón.
